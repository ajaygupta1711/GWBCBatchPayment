...
import org.openqa.selenium.support.ui.Select;
	...
	public class GWBCDDBatchPayment {
		...
		public static void main(String[] args) throws IOException, InterruptedException {
			...
			driver.get("https://bc-qa1-corecon.emc.dev-1.us-east-1.guidewire.net/PolicyCenter.do");
...
// Batch Payment Entry	
			...
			Thread.sleep(2000);
			driver.findElement(By.id("DesktopGroup-DesktopMenuActions")).click();
//			Thread.sleep(2000);
			driver.findElement(By.cssSelector("[id='DesktopGroup-DesktopMenuActions-DesktopMenuActions_NewPayment']")).click();
//			Thread.sleep(2000);
			driver.findElement(By.cssSelector("[id='DesktopGroup-DesktopMenuActions-DesktopMenuActions_NewPayment']")).click();
			driver.findElement(By.xpath("//div[contains(text(), 'Batch Payment Entry')]")).click();
			...
			driver.findElement(By.name("BatchPaymentEntryWizard-NewBatchPaymentScreen-BatchAmount")).sendKeys(data.get(4));
